...
} from "@features/lib/tiptap-utils"

// --- Icons ---
import { HeadingOneIcon } from "@features/components/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@features/components/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@features/components/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "@features/components/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "@features/components/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "@features/components/tiptap-icons/heading-six-icon"
